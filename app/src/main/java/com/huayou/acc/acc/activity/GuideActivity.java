...
import com.huayou.acc.acc.adapter.GuidePageAdapter;
...
public class GuideActivity extends AppCompatActivity implements ViewPager.OnPageChangeListener {
     ...
     * 加载底部圆点
     * */
    private void initPoint() {//这里实例化LinearLayout
        ...
        for (int i = 0;i<size;i++){
            ...
            if (i == 0){
                iv_point.setBackgroundResource(R.drawable.icon);
            }else{
                iv_point.setBackgroundResource(R.drawable.icon_default);
            }
 ...
    * 加载图片ViewPager
    ...
    private void initViewPager() {
        ...
        //实例化图片资源
        imageIdArray = new int[]{R.drawable.a,R.drawable.b,R.drawable.c};
 ...
   */
    ...
    public void onPageSelected(int position) {
        ...
        for (int i = 0;i<length;i++){
            ivPointArray[newPosition].setBackgroundResource(R.drawable.icon);
            if (newPosition != i){
            ivPointArray[i].setBackgroundResource(R.drawable.icon_default);
            }
        }
...
//        }
    ...
    @Override
    public void onDestroy() {// 注意结束的时候关闭线程
        super.onDestroy();
        isLooper = false;
    }
}